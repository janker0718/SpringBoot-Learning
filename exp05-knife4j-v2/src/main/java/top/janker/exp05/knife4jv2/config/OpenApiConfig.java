package top.janker.exp05.knife4jv2.config;
...
import top.janker.exp05.knife4jv2.constant.ResponseStatusEnum;
...
public class OpenApiConfig {
    ...
    private ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                ...
                .contact(new Contact("janker", "http://share-java.com", "690864766@qq.com"))
                .termsOfServiceUrl("http://share-java.com/")
                .version("1.0")
                .build();
    }
}